...
class SGDClientTrainer(ClientTrainer):
    """BaseClient backend handler, this class provides data process method to upper layer.
    ...
    Args:
        ...
        criterion (torch.nn.Loss): loss function used in local trainers process.
    ...
    def train(self, model_parameters) -> None:
        """BaseClient trains its local model on local dataset.
